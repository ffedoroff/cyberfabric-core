...
INSERT INTO resource_group_membership (group_id, resource_type, resource_id)
VALUES
    ('33333333-3333-3333-3333-333333333333', 'User', 'R4'),
    ('22222222-2222-2222-2222-222222222222', 'User', 'R5'),
    ('11111111-1111-1111-1111-111111111111', 'User', 'R4'),
    ('11111111-1111-1111-1111-111111111111', 'User', 'R6'),
    ('77777777-7777-7777-7777-777777777777', 'User', 'R8'),
    ('99999999-9999-9999-9999-999999999999', 'User', 'R0');
