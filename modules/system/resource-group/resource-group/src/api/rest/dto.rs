...
mod tests {
    ...
    fn dto_type_from_resource_group_type() {
        let rgt = ResourceGroupType {
            code: "gts.x.system.rg.type.v1~test.v1~".to_owned(),
            can_be_root: true,
        ...
        assert_eq!(dto.code, "gts.x.system.rg.type.v1~test.v1~");
    ...
    fn dto_create_type_to_request() {
        ...
        assert_eq!(req.code, "gts.x.system.rg.type.v1~test.v1~");
    ...
    fn dto_create_group_deserialize_type_key() {
        let json = r#"{"type": "gts.x.system.rg.type.v1~test.v1~", "name": "X"}"#;
        let dto: CreateGroupDto = serde_json::from_str(json).unwrap();
        assert_eq!(dto.type_path, "gts.x.system.rg.type.v1~test.v1~");
    ...
    fn dto_create_type_deserialize_missing_vectors_default_empty() {
        let json = r#"{"code": "gts.x.system.rg.type.v1~test.v1~", "can_be_root": true}"#;
