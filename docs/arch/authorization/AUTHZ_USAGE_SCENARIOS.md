...
| `group_hierarchy` _(Phase 2 — planned in PRs #1405, #1406)_ | resource_group_closure + resource_group_membership ✅ | **No** | `in_group_subtree` predicate | RG module only |
| `group_membership` _(Phase 2 — planned in PRs #1405, #1406)_ | resource_group_membership ✅ | **No** | `in_group` predicate | RG module only |
