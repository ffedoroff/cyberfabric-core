...
| **Rust integration tests** | **Done** | 24 tests: enforcer flow + tenant scoping + full-chain verification |
...
### Rust integration tests (24 tests)
...
## Phase 2: Group-Based Predicates _(Planned — implemented in PRs #1406–#1407)_
...
## Phase 3: MTLS Authentication Mode _(Planned — implemented in PR #1407)_
