...
async def test_create_and_get_type(rg_base_url, rg_headers, create_type):
    ...
    async with httpx.AsyncClient(timeout=10.0) as client:
        resp = await client.get(
            f"{rg_base_url}/cf/resource-group/v1/types/{code}",
            headers=rg_headers,
        )
...
async def test_create_and_get_group(rg_base_url, rg_headers, create_type, create_group):
    ...
    assert "tenant_id" in group_data, "Response should include tenant_id"

    async with httpx.AsyncClient(timeout=10.0) as client:
        resp = await client.get(
            f"{rg_base_url}/cf/resource-group/v1/groups/{group_id}",
            headers=rg_headers,
        )
        assert resp.status_code == 200
        fetched = resp.json()
        assert fetched["id"] == group_id
        assert fetched["tenant_id"] == group_data["tenant_id"]
...
async def test_group_has_tenant_id_from_security_context(rg_base_url, rg_headers, create_type, create_group):
    ...
    assert "tenant_id" in group_data
    ...
    assert group_data_2["tenant_id"] == tenant_id, (
...
async def test_group_hierarchy_returns_parent_and_children(rg_base_url, rg_headers, create_type, create_group):
    ...
    async with httpx.AsyncClient(timeout=10.0) as client:
        resp = await client.get(
            f"{rg_base_url}/cf/resource-group/v1/groups/{parent['id']}/hierarchy",
            headers=rg_headers,
        )
        assert resp.status_code == 200
        data = resp.json()
...
async def test_delete_group(rg_base_url, rg_headers, create_type, create_group):
    ...
    async with httpx.AsyncClient(timeout=10.0) as client:
        ...
        resp = await client.delete(
            f"{rg_base_url}/cf/resource-group/v1/groups/{group['id']}",
            headers=rg_headers,
        )
...
async def test_membership_add_and_list(rg_base_url, rg_headers, create_type, create_group):
    ...
    type_code = unique_type_code("mem_org")
    member_type = "task"
    ...
    async with httpx.AsyncClient(timeout=10.0) as client:
        await client.post(
            ...
            json={
                ...
                "can_be_root": True,
                "allowed_parents": [],
                "allowed_memberships": [member_type],
            },
        )
    ...
    async with httpx.AsyncClient(timeout=10.0) as client:
        ...
        resp = await client.put(
            f"{rg_base_url}/cf/resource-group/v1/groups/{group['id']}/memberships/{member_type}/{resource_id}",
            headers=rg_headers,
        )
        ...
        # List memberships
        resp = await client.get(
            f"{rg_base_url}/cf/resource-group/v1/memberships",
            headers=rg_headers,
        )
        assert resp.status_code == 200
        data = resp.json()
